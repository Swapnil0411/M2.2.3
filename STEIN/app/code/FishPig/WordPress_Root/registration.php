<?php
/**
 * FishPig_WordPress_Root by Ben Tideswell
 * https://fishpig.co.uk/
 */
	...
	**/
	...
	if (strpos($currentLocation, 'app' . DIRECTORY_SEPARATOR . 'code' . DIRECTORY_SEPARATOR) !== false) {
		$relativeLocation = 'app' . DIRECTORY_SEPARATOR . 'code' . DIRECTORY_SEPARATOR . 'FishPig' . DIRECTORY_SEPARATOR . 'WordPress_Root';
		...
		if (strpos($currentLocation, $relativeLocation) === false) {
			throw new \Exception(sprintf(
				...
				"FishPig_WordPress_Root",
				$relativeLocation,
				'FishPig' . DIRECTORY_SEPARATOR . 'WordPress_Root'
			));
		}
	}
