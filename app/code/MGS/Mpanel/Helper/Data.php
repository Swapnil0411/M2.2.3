...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
	...
	public function getColClass($perrow = NULL){
		...
		switch($perrow){
			case 2:
				return 'col-lg-6 col-md-6 col-sm-6 col-xs-12 col-xs-half';
				break;
			case 3:
				return 'col-lg-4 col-md-4 col-sm-4 col-xs-12 col-xs-half';
				break;
			case 4:
				return 'col-lg-3 col-md-3 col-sm-6 col-xs-12 col-xs-half';
				break;
			case 6:
				return 'col-lg-2 col-md-2 col-sm-3 col-xs-12 col-xs-half';
				break;
		}
		return;
	}
    ...
    public function getHeaderColorSetting($storeId) {
        $setting = [
			...
			'nav.navigation #mainMenu a.level0:hover, nav.navigation #mainMenu .level0 > a.ui-state-focus' => [
                'color' => $this->getStoreConfig('color/header/lv1_color_hover', $storeId)
            ],
			'.navigation ul.nav-main li a.level0::before,.navigation ul.nav-main li.dropdown a.level0::after' => [
				'background-color' => $this->getStoreConfig('color/header/lv1_color_hover', $storeId)
			],
