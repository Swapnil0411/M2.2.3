<?php
/**
 * FishPig_WordPress_GravityForms by Ben Tideswell
 * https://fishpig.co.uk/
 */
	...
	ComponentRegistrar::register(
		...
		'FishPig_WordPress_GravityForms',
		__DIR__
	);
	...
	**/
	...
	if (strpos($currentLocation, 'app' . DIRECTORY_SEPARATOR . 'code' . DIRECTORY_SEPARATOR) !== false) {
		$relativeLocation = 'app' . DIRECTORY_SEPARATOR . 'code' . DIRECTORY_SEPARATOR . 'FishPig' . DIRECTORY_SEPARATOR . 'WordPress_GravityForms';
		...
		if (strpos($currentLocation, $relativeLocation) === false) {
			throw new \Exception(sprintf(
				...
				"FishPig_WordPress_GravityForms",
				$relativeLocation,
				'FishPig' . DIRECTORY_SEPARATOR . 'WordPress_GravityForms'
			));
		}
	}
